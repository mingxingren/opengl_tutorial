...
int main(int, char**) {
    ...
    // ------------------------------------
    Shader lightingShader("materials.vs.glsl", "materials.fs.glsl");
 ...
 // positions          // normals           // texture coords
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        lightingShader.setVec3("light.position", camera.Position);       // 设置手电筒的位置
        lightingShader.setVec3("light.direction", camera.Front);    // 设置手电筒方向
        lightingShader.setFloat("light.cutOff", glm::cos(glm::radians(10.0f)));  // 手电筒内圆锥余弦值
        lightingShader.setFloat("light.outerCutOff", glm::cos(glm::radians(15.0f)));  // 手电筒外圆锥余弦值
