...
Collision CheckCollision(CBallObject& one, CGameObject& two);
...
GLboolean CheckCollision(CGameObject& one, CGameObject& two) // AABB - AABB collision
{
    // Collision x-axis?
...
Collision CheckCollision(CBallObject& one, CGameObject& two) // AABB - Circle collision
{
