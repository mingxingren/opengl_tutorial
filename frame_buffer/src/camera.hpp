...
public:
	...
	void ProcessKeyboard(Cemera_Movement direction, float deltaTime) {
		...
		if (direction == Cemera_Movement::FORWARD) {
			Position += Front * velocity;
		}
		else if (direction == Cemera_Movement::BACKWARD) {
			Position -= Front * velocity;
		}
		else if (direction == Cemera_Movement::LEFT) {
			Position -= Right * velocity;
		}
		else if (direction == Cemera_Movement::RIGHT) {
			Position += Right * velocity;
		}
	}
